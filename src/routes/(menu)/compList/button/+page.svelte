<script lang="ts">
  ...
  async function handleCopy(type: string) {
    const snippet = `<Button class="${type}">
</Button>`;
    await copy(snippet);
  ...
  async function handleCopySelf() {
    const snippet = `<Button
      class="rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-stone-50 shadow-lg transition-all duration-300 hover:from-pink-500 hover:to-yellow-500"
      >
</Button
    >`;
    await copy(snippet);
  ...
  const blue_fill = twMerge([
    // 白天 正常 禁用 悬浮 激活
    // 夜间 正常 禁用 悬浮 激活
    "text-stone-50 bg-blue-500 border-none",
  ...
  const blue_plain = twMerge([
    ...
    "hover:bg-blue-500 hover:text-stone-50 hover:border-transparent",
    "active:bg-blue-400",
  ...
  async function handleGenarate() {
    const colorMap = { blue_plain, blue_text, blue_fill };
    const result: string[] = [];
    tailwindColors.forEach((color) => {
      let tempText = `<Card caption={"按钮组件 - ${color}"}>
<Grid>`;
...
<Card caption={"按钮组件 - green"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-green-500 border-none disabled:text-stone-100 disabled:bg-green-300 hover:bg-green-600 active:bg-green-500 dark:text-stone-300 dark:bg-green-700 dark:disabled:text-stone-400 dark:disabled:bg-green-900 dark:hover:text-stone-100 dark:hover:bg-green-600 dark:active:text-stone-50 dark:active:bg-green-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-green-500 border-none disabled:text-stone-100 disabled:bg-green-300 hover:bg-green-600 active:bg-green-500 dark:text-stone-300 dark:bg-green-700 dark:disabled:text-stone-400 dark:disabled:bg-green-900 dark:hover:text-stone-100 dark:hover:bg-green-600 dark:active:text-stone-50 dark:active:bg-green-700",
...
<Card caption={"按钮组件 - red"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-red-500 border-none disabled:text-stone-100 disabled:bg-red-300 hover:bg-red-600 active:bg-red-500 dark:text-stone-300 dark:bg-red-700 dark:disabled:text-stone-400 dark:disabled:bg-red-900 dark:hover:text-stone-100 dark:hover:bg-red-600 dark:active:text-stone-50 dark:active:bg-red-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-red-500 border-none disabled:text-stone-100 disabled:bg-red-300 hover:bg-red-600 active:bg-red-500 dark:text-stone-300 dark:bg-red-700 dark:disabled:text-stone-400 dark:disabled:bg-red-900 dark:hover:text-stone-100 dark:hover:bg-red-600 dark:active:text-stone-50 dark:active:bg-red-700",
        )}>按钮 red_fill</Button
    >
    <Button
      class="text-stone-50 bg-red-500 border-none disabled:text-stone-100 disabled:bg-red-300 hover:bg-red-600 active:bg-red-500 dark:text-stone-300 dark:bg-red-700 dark:disabled:text-stone-400 dark:disabled:bg-red-900 dark:hover:text-stone-100 dark:hover:bg-red-600 dark:active:text-stone-50 dark:active:bg-red-700"
...
<Card caption={"按钮组件 - orange"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-orange-500 border-none disabled:text-stone-100 disabled:bg-orange-300 hover:bg-orange-600 active:bg-orange-500 dark:text-stone-300 dark:bg-orange-700 dark:disabled:text-stone-400 dark:disabled:bg-orange-900 dark:hover:text-stone-100 dark:hover:bg-orange-600 dark:active:text-stone-50 dark:active:bg-orange-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-orange-500 border-none disabled:text-stone-100 disabled:bg-orange-300 hover:bg-orange-600 active:bg-orange-500 dark:text-stone-300 dark:bg-orange-700 dark:disabled:text-stone-400 dark:disabled:bg-orange-900 dark:hover:text-stone-100 dark:hover:bg-orange-600 dark:active:text-stone-50 dark:active:bg-orange-700",
...
<Card caption={"按钮组件 - amber"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-amber-500 border-none disabled:text-stone-100 disabled:bg-amber-300 hover:bg-amber-600 active:bg-amber-500 dark:text-stone-300 dark:bg-amber-700 dark:disabled:text-stone-400 dark:disabled:bg-amber-900 dark:hover:text-stone-100 dark:hover:bg-amber-600 dark:active:text-stone-50 dark:active:bg-amber-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-amber-500 border-none disabled:text-stone-100 disabled:bg-amber-300 hover:bg-amber-600 active:bg-amber-500 dark:text-stone-300 dark:bg-amber-700 dark:disabled:text-stone-400 dark:disabled:bg-amber-900 dark:hover:text-stone-100 dark:hover:bg-amber-600 dark:active:text-stone-50 dark:active:bg-amber-700",
...
<Card caption={"按钮组件 - yellow"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-yellow-500 border-none disabled:text-stone-100 disabled:bg-yellow-300 hover:bg-yellow-600 active:bg-yellow-500 dark:text-stone-300 dark:bg-yellow-700 dark:disabled:text-stone-400 dark:disabled:bg-yellow-900 dark:hover:text-stone-100 dark:hover:bg-yellow-600 dark:active:text-stone-50 dark:active:bg-yellow-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-yellow-500 border-none disabled:text-stone-100 disabled:bg-yellow-300 hover:bg-yellow-600 active:bg-yellow-500 dark:text-stone-300 dark:bg-yellow-700 dark:disabled:text-stone-400 dark:disabled:bg-yellow-900 dark:hover:text-stone-100 dark:hover:bg-yellow-600 dark:active:text-stone-50 dark:active:bg-yellow-700",
...
<Card caption={"按钮组件 - lime"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-lime-500 border-none disabled:text-stone-100 disabled:bg-lime-300 hover:bg-lime-600 active:bg-lime-500 dark:text-stone-300 dark:bg-lime-700 dark:disabled:text-stone-400 dark:disabled:bg-lime-900 dark:hover:text-stone-100 dark:hover:bg-lime-600 dark:active:text-stone-50 dark:active:bg-lime-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-lime-500 border-none disabled:text-stone-100 disabled:bg-lime-300 hover:bg-lime-600 active:bg-lime-500 dark:text-stone-300 dark:bg-lime-700 dark:disabled:text-stone-400 dark:disabled:bg-lime-900 dark:hover:text-stone-100 dark:hover:bg-lime-600 dark:active:text-stone-50 dark:active:bg-lime-700",
        )}>按钮 lime_fill</Button
    >
    <Button
      class="text-stone-50 bg-lime-500 border-none disabled:text-stone-100 disabled:bg-lime-300 hover:bg-lime-600 active:bg-lime-500 dark:text-stone-300 dark:bg-lime-700 dark:disabled:text-stone-400 dark:disabled:bg-lime-900 dark:hover:text-stone-100 dark:hover:bg-lime-600 dark:active:text-stone-50 dark:active:bg-lime-700"
...
<Card caption={"按钮组件 - emerald"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-emerald-500 border-none disabled:text-stone-100 disabled:bg-emerald-300 hover:bg-emerald-600 active:bg-emerald-500 dark:text-stone-300 dark:bg-emerald-700 dark:disabled:text-stone-400 dark:disabled:bg-emerald-900 dark:hover:text-stone-100 dark:hover:bg-emerald-600 dark:active:text-stone-50 dark:active:bg-emerald-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-emerald-500 border-none disabled:text-stone-100 disabled:bg-emerald-300 hover:bg-emerald-600 active:bg-emerald-500 dark:text-stone-300 dark:bg-emerald-700 dark:disabled:text-stone-400 dark:disabled:bg-emerald-900 dark:hover:text-stone-100 dark:hover:bg-emerald-600 dark:active:text-stone-50 dark:active:bg-emerald-700",
...
<Card caption={"按钮组件 - teal"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-teal-500 border-none disabled:text-stone-100 disabled:bg-teal-300 hover:bg-teal-600 active:bg-teal-500 dark:text-stone-300 dark:bg-teal-700 dark:disabled:text-stone-400 dark:disabled:bg-teal-900 dark:hover:text-stone-100 dark:hover:bg-teal-600 dark:active:text-stone-50 dark:active:bg-teal-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-teal-500 border-none disabled:text-stone-100 disabled:bg-teal-300 hover:bg-teal-600 active:bg-teal-500 dark:text-stone-300 dark:bg-teal-700 dark:disabled:text-stone-400 dark:disabled:bg-teal-900 dark:hover:text-stone-100 dark:hover:bg-teal-600 dark:active:text-stone-50 dark:active:bg-teal-700",
        )}>按钮 teal_fill</Button
    >
    <Button
      class="text-stone-50 bg-teal-500 border-none disabled:text-stone-100 disabled:bg-teal-300 hover:bg-teal-600 active:bg-teal-500 dark:text-stone-300 dark:bg-teal-700 dark:disabled:text-stone-400 dark:disabled:bg-teal-900 dark:hover:text-stone-100 dark:hover:bg-teal-600 dark:active:text-stone-50 dark:active:bg-teal-700"
...
<Card caption={"按钮组件 - cyan"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-cyan-500 border-none disabled:text-stone-100 disabled:bg-cyan-300 hover:bg-cyan-600 active:bg-cyan-500 dark:text-stone-300 dark:bg-cyan-700 dark:disabled:text-stone-400 dark:disabled:bg-cyan-900 dark:hover:text-stone-100 dark:hover:bg-cyan-600 dark:active:text-stone-50 dark:active:bg-cyan-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-cyan-500 border-none disabled:text-stone-100 disabled:bg-cyan-300 hover:bg-cyan-600 active:bg-cyan-500 dark:text-stone-300 dark:bg-cyan-700 dark:disabled:text-stone-400 dark:disabled:bg-cyan-900 dark:hover:text-stone-100 dark:hover:bg-cyan-600 dark:active:text-stone-50 dark:active:bg-cyan-700",
        )}>按钮 cyan_fill</Button
    >
    <Button
      class="text-stone-50 bg-cyan-500 border-none disabled:text-stone-100 disabled:bg-cyan-300 hover:bg-cyan-600 active:bg-cyan-500 dark:text-stone-300 dark:bg-cyan-700 dark:disabled:text-stone-400 dark:disabled:bg-cyan-900 dark:hover:text-stone-100 dark:hover:bg-cyan-600 dark:active:text-stone-50 dark:active:bg-cyan-700"
...
<Card caption={"按钮组件 - indigo"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-indigo-500 border-none disabled:text-stone-100 disabled:bg-indigo-300 hover:bg-indigo-600 active:bg-indigo-500 dark:text-stone-300 dark:bg-indigo-700 dark:disabled:text-stone-400 dark:disabled:bg-indigo-900 dark:hover:text-stone-100 dark:hover:bg-indigo-600 dark:active:text-stone-50 dark:active:bg-indigo-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-indigo-500 border-none disabled:text-stone-100 disabled:bg-indigo-300 hover:bg-indigo-600 active:bg-indigo-500 dark:text-stone-300 dark:bg-indigo-700 dark:disabled:text-stone-400 dark:disabled:bg-indigo-900 dark:hover:text-stone-100 dark:hover:bg-indigo-600 dark:active:text-stone-50 dark:active:bg-indigo-700",
...
<Card caption={"按钮组件 - violet"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-violet-500 border-none disabled:text-stone-100 disabled:bg-violet-300 hover:bg-violet-600 active:bg-violet-500 dark:text-stone-300 dark:bg-violet-700 dark:disabled:text-stone-400 dark:disabled:bg-violet-900 dark:hover:text-stone-100 dark:hover:bg-violet-600 dark:active:text-stone-50 dark:active:bg-violet-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-violet-500 border-none disabled:text-stone-100 disabled:bg-violet-300 hover:bg-violet-600 active:bg-violet-500 dark:text-stone-300 dark:bg-violet-700 dark:disabled:text-stone-400 dark:disabled:bg-violet-900 dark:hover:text-stone-100 dark:hover:bg-violet-600 dark:active:text-stone-50 dark:active:bg-violet-700",
...
<Card caption={"按钮组件 - fuchsia"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-fuchsia-500 border-none disabled:text-stone-100 disabled:bg-fuchsia-300 hover:bg-fuchsia-600 active:bg-fuchsia-500 dark:text-stone-300 dark:bg-fuchsia-700 dark:disabled:text-stone-400 dark:disabled:bg-fuchsia-900 dark:hover:text-stone-100 dark:hover:bg-fuchsia-600 dark:active:text-stone-50 dark:active:bg-fuchsia-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-fuchsia-500 border-none disabled:text-stone-100 disabled:bg-fuchsia-300 hover:bg-fuchsia-600 active:bg-fuchsia-500 dark:text-stone-300 dark:bg-fuchsia-700 dark:disabled:text-stone-400 dark:disabled:bg-fuchsia-900 dark:hover:text-stone-100 dark:hover:bg-fuchsia-600 dark:active:text-stone-50 dark:active:bg-fuchsia-700",
...
<Card caption={"按钮组件 - pink"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-pink-500 border-none disabled:text-stone-100 disabled:bg-pink-300 hover:bg-pink-600 active:bg-pink-500 dark:text-stone-300 dark:bg-pink-700 dark:disabled:text-stone-400 dark:disabled:bg-pink-900 dark:hover:text-stone-100 dark:hover:bg-pink-600 dark:active:text-stone-50 dark:active:bg-pink-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-pink-500 border-none disabled:text-stone-100 disabled:bg-pink-300 hover:bg-pink-600 active:bg-pink-500 dark:text-stone-300 dark:bg-pink-700 dark:disabled:text-stone-400 dark:disabled:bg-pink-900 dark:hover:text-stone-100 dark:hover:bg-pink-600 dark:active:text-stone-50 dark:active:bg-pink-700",
        )}>按钮 pink_fill</Button
    >
    <Button
      class="text-stone-50 bg-pink-500 border-none disabled:text-stone-100 disabled:bg-pink-300 hover:bg-pink-600 active:bg-pink-500 dark:text-stone-300 dark:bg-pink-700 dark:disabled:text-stone-400 dark:disabled:bg-pink-900 dark:hover:text-stone-100 dark:hover:bg-pink-600 dark:active:text-stone-50 dark:active:bg-pink-700"
...
<Card caption={"按钮组件 - rose"}>
  <Grid>
    ...
    >
    <Button
      class="text-stone-50 bg-rose-500 border-none disabled:text-stone-100 disabled:bg-rose-300 hover:bg-rose-600 active:bg-rose-500 dark:text-stone-300 dark:bg-rose-700 dark:disabled:text-stone-400 dark:disabled:bg-rose-900 dark:hover:text-stone-100 dark:hover:bg-rose-600 dark:active:text-stone-50 dark:active:bg-rose-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-rose-500 border-none disabled:text-stone-100 disabled:bg-rose-300 hover:bg-rose-600 active:bg-rose-500 dark:text-stone-300 dark:bg-rose-700 dark:disabled:text-stone-400 dark:disabled:bg-rose-900 dark:hover:text-stone-100 dark:hover:bg-rose-600 dark:active:text-stone-50 dark:active:bg-rose-700",
        )}>按钮 rose_fill</Button
    >
    <Button
      class="text-stone-50 bg-rose-500 border-none disabled:text-stone-100 disabled:bg-rose-300 hover:bg-rose-600 active:bg-rose-500 dark:text-stone-300 dark:bg-rose-700 dark:disabled:text-stone-400 dark:disabled:bg-rose-900 dark:hover:text-stone-100 dark:hover:bg-rose-600 dark:active:text-stone-50 dark:active:bg-rose-700"
...
<Card caption={"按钮组件 - 灰色"}>
  <Grid>
    <Button
      class="text-stone-50 bg-slate-500 border-none disabled:text-stone-100 disabled:bg-slate-300 hover:bg-slate-600 active:bg-slate-500 dark:text-stone-300 dark:bg-slate-700 dark:disabled:text-stone-400 dark:disabled:bg-slate-900 dark:hover:text-stone-100 dark:hover:bg-slate-600 dark:active:text-stone-50 dark:active:bg-slate-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-slate-500 border-none disabled:text-stone-100 disabled:bg-slate-300 hover:bg-slate-600 active:bg-slate-500 dark:text-stone-300 dark:bg-slate-700 dark:disabled:text-stone-400 dark:disabled:bg-slate-900 dark:hover:text-stone-100 dark:hover:bg-slate-600 dark:active:text-stone-50 dark:active:bg-slate-700",
    ...
    <Button
      class="text-stone-50 bg-gray-500 border-none disabled:text-stone-100 disabled:bg-gray-300 hover:bg-gray-600 active:bg-gray-500 dark:text-stone-300 dark:bg-gray-700 dark:disabled:text-stone-400 dark:disabled:bg-gray-900 dark:hover:text-stone-100 dark:hover:bg-gray-600 dark:active:text-stone-50 dark:active:bg-gray-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-gray-500 border-none disabled:text-stone-100 disabled:bg-gray-300 hover:bg-gray-600 active:bg-gray-500 dark:text-stone-300 dark:bg-gray-700 dark:disabled:text-stone-400 dark:disabled:bg-gray-900 dark:hover:text-stone-100 dark:hover:bg-gray-600 dark:active:text-stone-50 dark:active:bg-gray-700",
        )}>按钮 gray_fill</Button
    >
    <Button
      class="text-stone-50 bg-gray-500 border-none disabled:text-stone-100 disabled:bg-gray-300 hover:bg-gray-600 active:bg-gray-500 dark:text-stone-300 dark:bg-gray-700 dark:disabled:text-stone-400 dark:disabled:bg-gray-900 dark:hover:text-stone-100 dark:hover:bg-gray-600 dark:active:text-stone-50 dark:active:bg-gray-700"
    ...
    <Button
      class="text-stone-50 bg-zinc-500 border-none disabled:text-stone-100 disabled:bg-zinc-300 hover:bg-zinc-600 active:bg-zinc-500 dark:text-stone-300 dark:bg-zinc-700 dark:disabled:text-stone-400 dark:disabled:bg-zinc-900 dark:hover:text-stone-100 dark:hover:bg-zinc-600 dark:active:text-stone-50 dark:active:bg-zinc-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-zinc-500 border-none disabled:text-stone-100 disabled:bg-zinc-300 hover:bg-zinc-600 active:bg-zinc-500 dark:text-stone-300 dark:bg-zinc-700 dark:disabled:text-stone-400 dark:disabled:bg-zinc-900 dark:hover:text-stone-100 dark:hover:bg-zinc-600 dark:active:text-stone-50 dark:active:bg-zinc-700",
        )}>按钮 zinc_fill</Button
    >
    <Button
      class="text-stone-50 bg-zinc-500 border-none disabled:text-stone-100 disabled:bg-zinc-300 hover:bg-zinc-600 active:bg-zinc-500 dark:text-stone-300 dark:bg-zinc-700 dark:disabled:text-stone-400 dark:disabled:bg-zinc-900 dark:hover:text-stone-100 dark:hover:bg-zinc-600 dark:active:text-stone-50 dark:active:bg-zinc-700"
    ...
    <Button
      class="text-stone-50 bg-neutral-500 border-none disabled:text-stone-100 disabled:bg-neutral-300 hover:bg-neutral-600 active:bg-neutral-500 dark:text-stone-300 dark:bg-neutral-700 dark:disabled:text-stone-400 dark:disabled:bg-neutral-900 dark:hover:text-stone-100 dark:hover:bg-neutral-600 dark:active:text-stone-50 dark:active:bg-neutral-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-neutral-500 border-none disabled:text-stone-100 disabled:bg-neutral-300 hover:bg-neutral-600 active:bg-neutral-500 dark:text-stone-300 dark:bg-neutral-700 dark:disabled:text-stone-400 dark:disabled:bg-neutral-900 dark:hover:text-stone-100 dark:hover:bg-neutral-600 dark:active:text-stone-50 dark:active:bg-neutral-700",
    ...
    <Button
      class="text-stone-50 bg-stone-500 border-none disabled:text-stone-100 disabled:bg-stone-300 hover:bg-stone-600 active:bg-stone-500 dark:text-stone-300 dark:bg-stone-700 dark:disabled:text-stone-400 dark:disabled:bg-stone-900 dark:hover:text-stone-100 dark:hover:bg-stone-600 dark:active:text-stone-50 dark:active:bg-stone-700"
      onclick={() =>
        handleCopy(
          "text-stone-50 bg-stone-500 border-none disabled:text-stone-100 disabled:bg-stone-300 hover:bg-stone-600 active:bg-stone-500 dark:text-stone-300 dark:bg-stone-700 dark:disabled:text-stone-400 dark:disabled:bg-stone-900 dark:hover:text-stone-100 dark:hover:bg-stone-600 dark:active:text-stone-50 dark:active:bg-stone-700",
...
<Card caption="按钮组件 - 自定义样式">
  <Button
    class="rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-stone-50 shadow-lg transition-all duration-300 hover:from-pink-500 hover:to-yellow-500"
    onclick={handleCopySelf}>自定义样式</Button
  >
</Card>
